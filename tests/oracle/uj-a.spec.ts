...
// TIER 2 (scaffold): the presentational layer is impl-first; every test is test.fixme until VI-559 builds it.
...
test.describe("UJ-A — Guided Full Onboarding (Start → Export)", () => {
  ...
  test.fixme("UJ-A.4 — Positioning: AI onliness proposal turn renders", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
  ...
  test.fixme("UJ-A.5 — Positioning challenge gate: keep or rewrite", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
  ...
  test.fixme("UJ-A.6 — Essence: lock 2–3 words via the onliness mad-lib", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
  ...
  test.fixme("UJ-A.7 — Personality: archetype + trait/antonym confirmation", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
    await expect(page.getByTestId("bw-root")).toHaveAttribute("data-stage", "strategy")
  ...
  test.fixme("UJ-A.8 — Pillars: confirm pillars and governed tokens", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
  ...
  test.fixme("UJ-A.10 — Tone: five live tone-by-context specimens on the canvas", async ({ page }) => {
    // activated by VI-559 build
    await page.goto(ROUTE)
