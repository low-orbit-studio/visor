...
<ComponentPreview
  ...
  code={"import { Alert, AlertTitle, AlertDescription, AlertActions } from '@/components/ui/alert/alert';\nimport { Button } from '@/components/ui/button/button';\n\n<Alert variant=\"destructive\">\n  <AlertTitle>Could not load data</AlertTitle>\n  <AlertDescription>The request timed out. Check your connection and try again.</AlertDescription>\n  <AlertActions>\n    <Button variant=\"ghost\" size=\"sm\">Dismiss</Button>\n    <Button variant=\"outline\" size=\"sm\">Retry</Button>\n  </AlertActions>\n</Alert>"}
>
  <div style={{ width: '100%' }}>
    <Alert variant="destructive">
      <AlertTitle>Could not load data</AlertTitle>
