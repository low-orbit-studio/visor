...
>
  <ChallengeCard>
    ...
    <ChallengeCardActions>
      <ChallengeCardAction variant="primary" onClick={() => {}}>Use the sharper version</ChallengeCardAction>
      <ChallengeCardAction variant="ghost" onClick={() => {}}>I&apos;ll rewrite it</ChallengeCardAction>
      <ChallengeCardGate />
    </ChallengeCardActions>
  </ChallengeCard>
</ComponentPreview>
...
>
  <ChallengeCard>
    ...
    <ChallengeCardBody>This is a high-stakes decision. You own the outcome.</ChallengeCardBody>
    <ChallengeCardActions>
      <ChallengeCardAction variant="primary" onClick={() => {}}>Proceed anyway</ChallengeCardAction>
      <ChallengeCardAction variant="ghost" onClick={() => {}}>Go back</ChallengeCardAction>
      <ChallengeCardGate>Human in the loop</ChallengeCardGate>
    </ChallengeCardActions>
  </ChallengeCard>
</ComponentPreview>
