...
<ComponentPreview
  title="Theme + Mode segmented pill"
  code={"import { ThemeSwitcher } from '@/components/ui/theme-switcher/theme-switcher';\n\nconst themes = [\n  { id: 'default', label: 'Default', bodyClass: '' },\n  { id: 'blackout', label: 'Blackout', bodyClass: 'blackout-theme' },\n];\n\n<ThemeSwitcher themes={themes} />"}
>
  <div style={{ minHeight: '4rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <ThemeSwitcher
      themes={[
        { id: 'docs-preview-default', label: 'Default', bodyClass: '' },
        { id: 'docs-preview-blackout', label: 'Blackout', bodyClass: '' },
      ]}
      themeStorageKey="docs-preview-theme-switcher-theme"
      modeStorageKey="docs-preview-theme-switcher-mode"
