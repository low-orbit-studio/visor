...
import { StructuredPrompt, StructuredPromptHeader, StructuredPromptBody, StructuredPromptSlot, StructuredPromptHint } from '@/components/ui/structured-prompt';
...
>
  <StructuredPrompt>
    <StructuredPromptBody>
      For{' '}
      <StructuredPromptSlot filled onClick={() => {}}>
        design-led product teams
      </StructuredPromptSlot>
      , we are the only…
    </StructuredPromptBody>
