...
A theme sets the label's size, case, tracking and colour through the `field`
component tokens, in both densities. See
[Component tokens](/docs/themes/component-tokens#field).
