...
>
  <div style={{ width: '100%', maxWidth: '20rem' }}>
    <div style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
      PhoneInput requires a browser environment for intl-tel-input initialization.
      In the docs preview, it renders as a basic tel input (SSR fallback).
    </div>
  </div>
</ComponentPreview>
...
>
  <div style={{ width: '100%', maxWidth: '20rem' }}>
    <div style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
      The onChange callback returns both the full international number (e.g. &quot;+14155551234&quot;) and a validation boolean.
    </div>
  </div>
</ComponentPreview>
...
>
  <div style={{ width: '100%', maxWidth: '20rem' }}>
    <div style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
      Disabled state prevents interaction with both the input and country selector.
    </div>
  </div>
</ComponentPreview>
