...
import {
  ConfirmDialogInfoDemo,
  ConfirmDialogWarningDemo,
  ConfirmDialogDangerDemo,
  ConfirmDialogConfirmTextDemo,
  ConfirmDialogCustomBodyDemo,
} from '@/components/ui/confirm-dialog-demo';
