...
Visor ships light and dark themes out of the box via `@loworbit/visor-tokens`. Both themes are CSS-only — no JavaScript required for the default behavior.
...
The `@loworbit/visor-tokens` package exports utilities for toggling themes programmatically:

```ts
import { applyTheme, getSystemTheme } from '@loworbit/visor-tokens';
...
```ts
import { applyTheme, getSystemTheme, type Theme } from '@loworbit/visor-tokens';
...
@import '@loworbit/visor-tokens/primitives';

/* Semantic tokens only */
@import '@loworbit/visor-tokens/semantic';

/* Light theme adaptive tokens */
@import '@loworbit/visor-tokens/themes/light';

/* Dark theme adaptive tokens (manual selectors + media query) */
@import '@loworbit/visor-tokens/themes/dark';
```
