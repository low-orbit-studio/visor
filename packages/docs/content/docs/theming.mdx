...
Visor ships light and dark themes out of the box via `@loworbitstudio/visor`. Both themes are CSS-only — no JavaScript required for the default behavior.
...
The `@loworbitstudio/visor` package exports utilities for toggling themes programmatically:

```ts
import { applyTheme, getSystemTheme } from '@loworbitstudio/visor';
...
```ts
import { applyTheme, getSystemTheme, type Theme } from '@loworbitstudio/visor';
...
@import '@loworbitstudio/visor/primitives';

/* Semantic tokens only */
@import '@loworbitstudio/visor/semantic';

/* Light theme adaptive tokens */
@import '@loworbitstudio/visor/themes/light';

/* Dark theme adaptive tokens (manual selectors + media query) */
@import '@loworbitstudio/visor/themes/dark';
```
