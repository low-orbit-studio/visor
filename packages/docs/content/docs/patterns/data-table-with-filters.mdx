...
import { DataTableWithFiltersDemo } from '@/components/patterns/data-table-with-filters-demo';

## Preview

<BlockPreview title="Data Table With Filters" code={"<AdminListPageDemo />"}>
...
- For per-row action menus, bulk selection, and confirm-on-delete, use the [Data Table Row Actions](/docs/patterns/data-table-row-actions) pattern — the two compose (filter toolbar above, row actions per row).
