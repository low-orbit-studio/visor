...
<BlockPreview
  title="Admin Settings Page — grouped nav"
  code={"<AdminSettingsPage\n  title=\"Settings\"\n  sectionGroups={[\n    {\n      label: 'Account',\n      sections: [\n        { id: 'profile', label: 'Profile', title: 'Profile', content: <ProfilePanel /> },\n        { id: 'security', label: 'Security', title: 'Security', content: <SecurityPanel /> },\n        { id: 'notifications', label: 'Notifications', title: 'Notifications', content: <NotificationsPanel /> },\n        { id: 'tokens', label: 'Personal access', title: 'Personal access tokens', content: <TokensPanel /> },\n      ],\n    },\n    {\n      label: 'Workspace',\n      sections: [\n        { id: 'general', label: 'General', title: 'General', content: <GeneralPanel /> },\n        { id: 'members', label: 'Members', meta: '8', title: 'Members', content: <MembersPanel /> },\n        { id: 'billing', label: 'Billing', title: 'Billing', content: <BillingPanel /> },\n        { id: 'integrations', label: 'Integrations', title: 'Integrations', content: <IntegrationsPanel /> },\n        { id: 'api', label: 'API & webhooks', title: 'API & webhooks', content: <ApiPanel /> },\n        { id: 'audit', label: 'Audit log', title: 'Audit log', content: <AuditPanel /> },\n      ],\n    },\n    {\n      label: 'Venue',\n      sections: [\n        { id: 'venue-default', label: 'House of Yes', meta: 'default', title: 'House of Yes', content: <VenuePanel /> },\n        { id: 'venue-moodering', label: 'Mood Ring', title: 'Mood Ring', content: <VenuePanel /> },\n        { id: 'venue-add', label: '+ Add venue', muted: true, title: 'Add a venue', content: <AddVenuePanel /> },\n      ],\n    },\n  ]}\n  hideFooter\n/>"}
>
  <AdminSettingsPageGroupedDemo />
</BlockPreview>
...
- **Per-section extras** — `meta` (trailing badge in side rail, suppressed in top bar) and `muted` (dims nav text via `--text-tertiary`).
