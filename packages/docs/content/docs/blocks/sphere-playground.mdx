...
The floating configuration panel provides real-time control over:

- **Geometry** — Switch between 5 particle distribution modes
- **Color** — Choose from 5 color schemes
- **Appearance** — Adjust dot size, speed, blur, saturation, and lightness
- **Think Mode** — Control the think-mode animation intensity
