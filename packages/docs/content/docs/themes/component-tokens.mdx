...
| `--chip-border` | Chip resting edge, as one `<width> <style> <colour>` value. Defaults to the shared `control` edge, so `control.edge-width: 0` turns it off. | `var(--control-edge-width, var(--stroke-width-thin, 1px)) var(--control-edge-style, solid) var(--control-edge-color, var(--border-default, #e5e7eb))` |
...
| `--empty-state-border` | Default-tone dashed edge, as one `<width> <style> <colour>` value. Defaults to the shared `control` drop edge, so `control.edge-width: 0` turns it off. | `var(--control-drop-edge-width, var(--control-edge-width, 1px)) var(--control-drop-edge-style, dashed) var(--control-edge-color, var(--border-default, #e5e7eb))` |
...
| `--checkbox-border` | Unchecked resting edge, as one `<width> <style> <colour>` value. Defaults to the shared `control` edge, so `control.edge-width: 0` turns it off. | `var(--control-edge-width, 1px) var(--control-edge-style, solid) var(--control-edge-color, var(--border-default, #e5e7eb))` |
