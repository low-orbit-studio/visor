...
| `--field-label-text-transform` | Label casing. | `inherit` |
| `--field-label-letter-spacing` | Label tracking. | `inherit` |
...
| `--text-xs-text-transform` | `xs` casing. | `inherit` |
| `--text-xs-letter-spacing` | `xs` tracking. | `inherit` |
| `--text-sm-font-size` | `sm` type size. | `var(--font-size-sm, 0.875rem)` |
| `--text-sm-text-transform` | `sm` casing. | `inherit` |
| `--text-sm-letter-spacing` | `sm` tracking. | `inherit` |
| `--text-md-font-size` | `md` type size. | `var(--font-size-base, 1rem)` |
| `--text-md-text-transform` | `md` casing. | `inherit` |
| `--text-md-letter-spacing` | `md` tracking. | `inherit` |
| `--text-lg-font-size` | `lg` type size. | `var(--font-size-lg, 1.125rem)` |
| `--text-lg-text-transform` | `lg` casing. | `inherit` |
| `--text-lg-letter-spacing` | `lg` tracking. | `inherit` |
| `--text-xl-font-size` | `xl` type size. | `var(--font-size-xl, 1.25rem)` |
| `--text-xl-text-transform` | `xl` casing. | `inherit` |
| `--text-xl-letter-spacing` | `xl` tracking. | `inherit` |
