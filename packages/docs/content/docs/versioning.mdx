...
`@loworbitstudio/visor` is the only npm-distributed piece of Visor. It follows [Semantic Versioning](https://semver.org/).
...
After completing work that affects `@loworbitstudio/visor`, run:
...
- [Release Notes](/docs/releases) — full changelog for `@loworbitstudio/visor`
