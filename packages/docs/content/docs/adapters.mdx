...
npx @loworbitstudio/visor theme apply themes/blacklight/theme.visor.yaml \
  --adapter nextjs \
  --scope-prefix 'body.blacklight-theme'
```

Generated output:

```css
body.blacklight-theme {
  --surface-page: ...;
  /* primitives + light tokens */
}

body.blacklight-theme.dark,
body.blacklight-theme.theme-dark,
body.blacklight-theme[data-theme="dark"] {
  /* dark-mode overrides */
}
```
