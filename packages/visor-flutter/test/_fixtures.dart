...
/// Builds a minimal [VisorColorsData] suitable for tests that need a theme
/// with all semantic slots populated. The values here are not meaningful —
/// they cover the required constructor surface.
