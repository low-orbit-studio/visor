...
- da15987: Add lit-surface elevation utilities — three opt-in CSS utility classes (`.lit`, `.lit-soft`, `.lit-strong`) with a live keyed accent halo via `--lit-color` (VI-568).
...
- 92f8a7c: Soften dark-mode status `-subtle` surfaces (VI-500). In dark mode,
